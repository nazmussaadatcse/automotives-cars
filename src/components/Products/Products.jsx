                        ...
                        <div key={car._id} className="bg-slate-100 rounded-lg">
                            <div className="p-4 flex flex-col bg-slate-100 justify-center items-center">
                                ...
                                <div className="py-4 p-2 text-left w-full">
                                    <p className="text-xl font-semibold text-purple-900">{car?.name}</p>
                                ...
                                <div className="py-4 uppercase p-2 text-left w-full">
                                    <p><span className="font-semibold text-purple-900">Brand:</span> {car?.brand}</p>
                                    <p><span className="font-semibold text-purple-900">Type:</span> {car?.type}</p>
                                    <p><span className="font-semibold text-purple-900">Ratings:</span> {car?.ratings}/5</p>
